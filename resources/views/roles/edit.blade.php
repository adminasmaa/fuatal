                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" style="border:none; min-height:0; ">
                            <h3 class="card-title py-5">Role Edit Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="leave-apply-form" action="{{route('admin.roles.update', $data->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6 text-right">
                                        <input type="submit" name="submit" value="Update Role" class="w-100 btn btn-primary"/>
                                    </div>
                                </div>
                            </form>
                        </div>
