...
<section class="section">
    ...
    margin-top: 13px;">
            ...
            <div class="card-content" style="padding-bottom: 2rem;">
                <div class="container-fluid">
                    <h5 class="py-5">Add Tel Company Detail</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{url('/admin/tcompany/save')}}">
                        @csrf
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row">
                                <label class="required fs-5 fw-bold mb-2">Company Logo</label>

                                <input class="form-control" value="" type="file" name="logo" required>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row">
                                ...
                                <input class="form-control" value="" type="text" name="prefix" required="required">
