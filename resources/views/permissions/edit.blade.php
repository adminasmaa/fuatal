            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.permissions.all')}}">Departments</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="leave-apply-form" action="{{route('admin.permissions.update',$data->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
