                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5" style="display:block">
                                <div class="card-title">
                                    <p class="card-header-title">
                                        {{ 'All Generated Codes [Instant Gift]' }}
                                        @if (isset($link))
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{url('/admin/export-lottery-numbers', ['type' => 'gift'])}}" class="btn btn-info btn-sm">Export Excel</a>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    @if(count($lotteryListing))
                                    <div class="col-md-8">
                                        <form name="exportPdfQrcodes" action="{{url('/admin/export-pdf-qrcodes', ['type' => 'gift'])}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-5">
