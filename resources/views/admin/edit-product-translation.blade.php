...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{url('admin/translate/product/update')}}">
         @csrf
...
@php
$eng_prod = Product::where('trans_id', $dataObj->trans_id)->where('lang_name', 'English')->first();
@endphp
            <div class="field">
    <label class="label">Product Title*</label>
    <div class="control">
        <label class="label">English title</label>
         <input readonly disabled class="input" value="{{$eng_prod->title}}" type="text" name="title_english">
 ...
 <div class="field" style="display: none;">
    ...
    <div class="control">
                <input dir="rtl" class="input" value="{{$dataObj->product_size}}" type="text" name="product_size">
...
<div class="field" style="display:none;">
    ...
    <div class="control">
         <input class="input" value="{{$dataObj->price}}" type="number" name="price">
 ...
 <textarea name="desc_english" style="width: 100%;" disabled readonly>{!! $eng_prod->description !!}</textarea>
 <textarea dir="rtl" id="description" name="description" class="textarea trumbowyg-textarea">{!! $dataObj->description !!}</textarea>
...
<div class="field">
    ...
    <label class="label">English nutritional info</label>
 <textarea name="nutritional_info_english" style="width: 100%;" disabled readonly>{{ html_entity_decode($eng_prod->nutritional_info) }}</textarea>
                <textarea dir="rtl" id="editor_new" name="ckeditor nutritional_info" class="textarea trumbowyg-textarea">{!! $dataObj->nutritional_info !!}</textarea>
