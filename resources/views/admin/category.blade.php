...
<section class="section">
    ...
    margin-top: 13px;">
            ...
            <div class="card-content" style="padding-bottom: 2rem;">
                <div class="container-fluid">
                    <h5 class="py-5">Add Category Detail</h5>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12 mb-5 fv-row">
                            ...
                            <input type="color" class="from-control" name="color_code" value="#ffffff" required />
                        </div>
                        <div class="col-md-6 fv-row">
                            ...
                            <input id="image_select" type="file" name="cat_image_before" class="form-control" required>
                            <input id="image_original" type="hidden" name="cat_image" class="form-control" style="height: 46px !important;margin-bottom:13px">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="required fs-5 fw-bold mb-2">Title Arabic</label>
