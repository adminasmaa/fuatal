...
@section('content')
    ...
    @endif
                <div class="card-content" style="padding-bottom: 2rem;">
                    <div class="container-fluid">
        <h1 class="title">Subcategory2 Form</h1>
    <form method="POST" enctype="multipart/form-data" action="{{route('admin.subcategoryfinal.store')}}">
         @csrf
        <div class="field">
      ...
      <button class="button is-small is-danger" type="submit" onclick="deleteRecord({{$item->id}})">
            ...
            <span>Edit</span>
            		...
            		<td>
            			...
            			@else
            			<img width="70px" src="{{URL::asset('uploads/categories/'.$item->subcat_image_final)}}">
            			@endif
            		</td>
            		<td>{{$item->title}}</td>
...
function deleteRecord(id){
        ...
        var url="{{url('admin/delete/subcat/final')}}";
        //alert(url);
        $.get(url,{id:id},function(arg) {
          location.reload();
            // body...
